<script lang="ts">
    ...
    let data: any = {
        ...
        IV_Lesoes_Nao_Fatais: false,
        IV_Defic_vitimizacao: "",
        IV_Defic_vitimizacao_tipo: "",
        IV_Problemas_De_Saude: false,
        IV_Comp_Cogn_Comport: false,
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <span
                            class="block text-sm font-medium text-gray-700 mb-1"
                        >
                            É responsável por membro/s do grupo familiar com
                            alguma deficiência, comorbidade ou outra
                            vulnerabilidade?
                        </span>
                        <div class="flex gap-4">
                            <label class="inline-flex items-center">
