...
CREATE TABLE "SAVe_Situacao_Juridica" (
    ...
    "SJ_Data_Fatos" TIMESTAMP,
    "SJ_Tipo_Penal_Fatos" TEXT,
    "SJ_Data_Autuacao_IP" TIMESTAMP,
    "SJ_Tipo_Penal_Autuacao_IP" TEXT,
    "SJ_Data_Conclusao_IP" TIMESTAMP,
    "SJ_Tipo_Penal_Conclusao_IP" TEXT,
    "SJ_Data_Denuncia_Repres" TIMESTAMP,
    "SJ_Tipo_Penal_Denuncia_Repres" TEXT,
    "SJ_Data_Audiencia" TIMESTAMP,
    "SJ_Tipo_Penal_Audiencia" TEXT,
    "SJ_Data_Sentenca" TIMESTAMP,
    "SJ_Tipo_Penal_Sentenca" TEXT,
    "SJ_Data_Transito_Julgado" TIMESTAMP,
...
CREATE TABLE "SAVe_Ensino-trab-renda" (
    "ID_Caso" INTEGER PRIMARY KEY,
